...
export default function FindUsPageClient() {
  return (
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-[family-name:var(--font-dm-sans)] text-sm leading-relaxed text-[#7A7068]">
                    The name says it all &mdash; La Fermata (The Stop) is just a
                    few steps from the tram and bus stop on Corso De Gasperi.
                    Easily reachable by car as well, with parking available in
                    nearby streets.
                  </p>
                </div>
              </div>
